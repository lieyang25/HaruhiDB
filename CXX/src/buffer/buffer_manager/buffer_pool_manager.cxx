...
namespace buffer
{
    ...
    {
        // TODO:
        // 1. 检查 page_id 是否在 page_table_ 中。
        // 2. 如果该页 pin_count > 0，说明正在被使用，无法删除，返回 false。
        // 3. 从 page_table_ 移除映射。
        // 4. 将对应的 frame_id 回收到 frame_list_ 中。
        // 5. 调用 disk_manager_->DeallocatePage()（可选）。
        return false;
    }
